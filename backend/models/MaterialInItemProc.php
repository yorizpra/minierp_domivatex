...
class MaterialInItemProc extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['id_material_in', 'yard_awal', 'yard_hasil1', 'yard_hasil2', 'yard_hasil3', 'yard_hasil4', 'yard_hasil5', 'yard_hasil6', 'yard_hasil_total', 'buang1', 'buang2', 'is_packing', 'id_basic_packing', 'created_id_user',
                'id_basic_packing1', 'id_basic_packing2', 'id_basic_packing3', 'id_basic_packing4', 'id_basic_packing5', 'id_basic_packing5', 'created_id_user'
                ], 'integer'],
            [['created_date'], 'safe'],
