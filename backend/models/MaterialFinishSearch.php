...
class MaterialFinishSearch extends MaterialFinish
{
    ...
    {
        return [
            [['id_material_finish', 'id_material', 'id_material_kategori1', 'id_material_kategori2', 'id_material_kategori3', 'yard', 'year', 'no_urut', 'is_packing', 'id_basic_packing', 'id_material_in_item_proc', 'id_material_in', 'id_gudang', 'created_id_user'], 'integer'],
